...
* Custom photo feed
* Post photo, Video posts from camera or gallery
    * Like posts
    * Comment on posts
        * View all comments on a post
        * Long Click Delete Comment
* Search for users
* Profile Management:
    * Users can create, update, and delete their profiles,      including profile pictures and personal information.
* Contact Screen
* Create Community
    * Community Management for Mods
    * Unread Message Count
    * Long click delete Chat
* Realtime Messaging and Sending images
    * Lastest Message, Time sent
    * Online/Offline Status
* Push Message Notifications
* Realtime Messaging and Sending images in Community
* Deleting Posts
* Profile Pages
...
* Notifications Feed showing recent likes / comments of your posts + new followers
    * Read all, Delete all Notifications
* Dark Mode Support
* Stories/Status
