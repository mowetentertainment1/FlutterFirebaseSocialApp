...
class UserShortVideo extends ConsumerStatefulWidget {
  final String uid;
  final int index;
  const UserShortVideo({super.key, required this.uid, required this.index});

  @override
  ConsumerState createState() => _UserShortVideoState();
}

class _UserShortVideoState extends ConsumerState<UserShortVideo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   ],
      // ),
      body: ref.watch(getUserShortVideosUidProvider(widget.uid)).when(
            data: (shortVideos) {
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ref
                                                .read(getUserDataProvider(data.userUid))
                                                .when(
                                                  data: (user) {
                                                    return buildProfile(
                                                      user.profilePic,
